...
class TestE2ESmoke:
    ...
    def test_full_lifecycle(self):
        ...
        with patch("automate.registry.registry.get_connector") as mock_get:
            ...
            mock_connector.redact.side_effect = lambda x: x
            mock_connector.execute.return_value = MagicMock(data={"ok": True}, status="success", meta={})
            # Ensure it has name/slug/config_schema to satisfy any runtime checks
