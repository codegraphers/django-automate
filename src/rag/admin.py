...
class KnowledgeSourceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Ownership', {
            'fields': ('owner_team', 'tags', 'created_by')
        }),
        ('Metadata', {
...
class RAGEndpointAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Access Control', {
            'fields': ('access_policy', 'rate_limit'),
            'description': 'RBAC rules and rate limiting.'
        }),
        ('API Info', {
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        extra_context['test_query_url'] = reverse(
            'admin:rag_ragendpoint_test_query',
            args=[object_id]
        )
