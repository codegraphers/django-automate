...
class AutomationWizardView(View):
    def get(self, request):
        ...
        return render(
            request,
            "admin/automate/studio/wizard.html",
            {
    ...
    def post(self, request):
        ...
        try:
            ...
            return JsonResponse({"status": "draft_created", "graph": draft_graph})
    ...
    def _mock_nlp_to_graph(self, intent):
        ...
        if "order" in intent.lower() or "shopify" in intent.lower():
            ...
            nodes.append({"id": "trigger_1", "type": "trigger", "title": "Webhook", "x": 100, "y": 200, "config": "{}"})
    ...
    def put(self, request):
        ...
        try:
            ...
            if format_type == "n8n":
                ...
                return JsonResponse({"status": "imported", "graph": nodes})
