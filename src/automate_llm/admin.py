...
class LLMRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Request Info", {"fields": ["provider", "model", "prompt_slug", "purpose", "tenant_id"]}),
        ("Input/Output (for debugging)", {"fields": ["input_payload", "output_content"], "classes": ["collapse"]}),
        ("Usage", {"fields": ["input_tokens", "output_tokens", "cost_usd", "latency_ms"]}),
