...
class AutomateDataChatConfig(AppConfig):
    ...
    def ready(self):
        ...
        # =====================================================================
        User = get_user_model()
        DataChatRegistry.register(User, tags=["users", "auth"])
        ...
        from automate.models import (
            ...
            ConnectionProfile, BudgetPolicy, Template,
            MCPServer, MCPTool, PromptRelease,
        )
        ...
        from automate_core.models import (
            Event, Automation, Workflow, Trigger, Execution, StepRun,
            SideEffectLog, Artifact, Job, JobEvent, OutboxItem, Policy, RuleSpec,
        )
        ...
        from automate_modal.models import (
            ModalProviderConfig, ModalEndpoint, ModalJob, ModalArtifact, ModalAuditEvent,
        )
        ...
        # =====================================================================
        from rag.models import KnowledgeSource, RAGEndpoint, EmbeddingModel, RAGQueryLog
