...
class ModalEndpoint(models.Model):
    ...
    allowed_task_types = models.JSONField(default=list, help_text="List of allowed ModalTaskType strings")
    ...
    access_policy = models.JSONField(
        default=dict, blank=True, help_text="RBAC policy: allowed_groups, allowed_users, etc."
    )
